...
                <span className='whitespace-nowrap' style={{ display: 'none' }}>
                    <i className='far fa-calendar mr-2' />{post?.publishDay}
                </span>
                <span className='mx-1' style={{ display: 'none' }}>|</span>
                <span className='whitespace-nowrap mr-2' style={{ display: 'none' }}>
                    <i className='far fa-calendar-check mr-2' />{post?.lastEditedDay}
                </span>
